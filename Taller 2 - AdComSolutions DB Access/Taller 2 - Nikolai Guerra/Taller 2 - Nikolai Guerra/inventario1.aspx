<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="inventario1.aspx.vb" Inherits="Taller_2___Nikolai_Guerra.inventario1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AdComSolution - Ver Inventario</title>
    <!--FUENTES-->
    ...
    <link href="inventario1.css" rel="stylesheet" />
</head>
<body oncontextmenu="return false">
    ...
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ADCOMConnectionString2 %>" DeleteCommand="DELETE FROM [inventario] WHERE [Placa1] = ?" InsertCommand="INSERT INTO [inventario] ([Placa1], [Placa2], [Activo], [Fecha], [Marca], [Modelo], [Serie], [Factura], [Provedor], [Monto]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" ProviderName="<%$ ConnectionStrings:ADCOMConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM [inventario]" UpdateCommand="UPDATE [inventario] SET [Placa2] = ?, [Activo] = ?, [Fecha] = ?, [Marca] = ?, [Modelo] = ?, [Serie] = ?, [Factura] = ?, [Provedor] = ?, [Monto] = ? WHERE [Placa1] = ?">
            <DeleteParameters>
